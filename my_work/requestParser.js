...
exports.parseRequest = function(data, mappings) {
  ...
  if(words[1] == "/") {
	...
	return request;
      ...
      if(mappings.paths[e].module && (words[1].startsWith(mappings.paths[e].path+"/") || words[1] == mappings.paths[e].path)) {
        if(mappings.paths[e].methods) {
	  secondSlashKey = words[1].indexOf("/",1);
          methodKey = secondSlashKey == -1 ? "/" : words[1].substring(secondSlashKey);
